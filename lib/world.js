		...
		Events: {
			...
			moved: function(socket, data) {
				...
				if(world.canGoTo(newPos[0], newPos[1])) {
					...
					if(newPos[0] === 65 && newPos[1] === 154) {
						newPos = [90,240];
					}
					else if(newPos[0] === 90 && newPos[1] === 238) {
						newPos = [64,153];
					}
					else if(newPos[0] === 35 && newPos[1] === 206) {
						newPos = [129,163];
					}
